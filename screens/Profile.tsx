...
function Profile(props) {
  ...
  useEffect(() => {
    ...
    animateIntro();
  }, [cardTranslateY, introOpacity, introScale, introTranslateY]);
    ...
    <PageWrapper style={{ height: screenHeight }}>
        ...
        <CardWrapper style={{ width: screenWidth }}>
          ...
          >
            <Column style={{ alignItems: "center" }}>
              <ImageWrapper>
                <Image source={require("../assets/images/Sophie.png")} />
                <CheckImage>
                  <Feather
                    name="check"
                    color="white"
      ...
      >
        <DateWrapper>
          <Date>April, 25</Date>
          <Actions>
            <Feather name="list" size={22} color={props.theme.blackText} />
            <Feather name="calendar" size={19} color={props.theme.grayText} />
          </Actions>
        </DateWrapper>
      </Animated.View>
      <Animated.View
